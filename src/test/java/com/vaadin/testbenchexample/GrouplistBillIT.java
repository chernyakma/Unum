...
public class GrouplistBillIT extends BaseLoginTest {
    ...
    public void suspense() throws InterruptedException {
        ...
        getGroup.searchByGroup().sendKeys( "41715" );
        getGroup.searchButton().click();
        getGroup.family().getCell( "41715" ).click();
        ...
        suspenseSource.suspenseAmountAccept().setValue( "88.00" );
        Assertions.assertEquals( "88.00",suspenseSource.suspenseAmountAccept().getValue() );
...
//				Assertions.assertEquals( "$100,000.00",checkSuspence.suspenceBalance().getText() );
        ...
        transferSuspence.searchFamily().sendKeys( "41715" );
        transferSuspence.search().doubleClick();
        transferSuspence.family().getCell( "41715" ).click();
        transferSuspence.toAccountAccept().selectByText( "List Bill" );
        transferSuspence.transferAmountAccept().setValue( "88.00" );
        Assertions.assertEquals( "88.00",transferSuspence.transferAmountAccept().getValue() );
...
//		ScenarioView suspenceAmount=$(ScenarioView.class).first();
 ...
 //       EntryDialogContent selectTransaction = $(EntryDialogContent.class).first();
        ...
        selectTransaction.effectiveDate().setDate(LocalDate.of(2032,12,25));
...
//		Assertions.assertFalse(transactionsPage.transactionStatus().getCell("Pending").isDisplayed());
 ...
 //       Thread.sleep(10_000);
        waitUntil(driver -> payBill.processBillAccept().isEnabled(),200);
